set search_path = oe;
create or replace view oc_corporate_customers (customer_id, cust_first_name, cust_last_name, cust_address, phone_numbers, nls_language, nls_territory, credit_limit, cust_email, cust_orders, account_mgr_id) as select  c.customer_id, c.cust_first_name, c.cust_last_name,
